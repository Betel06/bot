...
from smc_bot.config import ATIVOS, BB_LENGTH, BB_MULT, VOL_MULTIPLIER, CHECK_INTERVAL_SECONDS
...
RESULTADOS_FILE = os.path.join(BOT_DIR, "logs", "smc_resultados.json")
...
def enviar_telegram(mensagem):
    try:
        from smc_bot.telegram import enviar_mensagem
...
def keep_alive_loop():
    url = os.environ.get("RENDER_EXTERNAL_URL") or ("http://127.0.0.1:" + os.environ.get("PORT", "5003"))
    while True:
        try:
